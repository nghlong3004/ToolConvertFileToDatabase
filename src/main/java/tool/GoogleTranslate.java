...
public final class GoogleTranslate { //Class marked as final since all methods are static
    ...
    private static String generateURL(String sourceLanguage, String targetLanguage, String text) 
        ...
        sb.append("&dt=t");
        // bd -> trả về từ loại
        // ex -> trả về các ví dụ chỉ có tiếng anh
        // ss -> trả về các từ đồng nghĩa nếu có
        //This parameters requests the translated text back.
        //Other parameters request additional information such as pronunciation, and so on.
    ...
    public static String detectLanguage(String text) throws IOException{
        ...
        URL obj = uri.toURL();
        String rawData = urlToText(obj);//Gets text from Google
